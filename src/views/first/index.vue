<template>
  <div class="box-card">
    ...
    <div class="box">
      <div class="item div1 shou" @click="on1">
        1.RCG480系统毁伤效果评估作战效能指标
      </div>
      <div class="item div2 shou" @click="on2">
        2.扩展型对抗系统毁伤效果评估指标体系
      </div>
      <div class="item div3 shou" @click="on3">
        3.RCL673系统毁伤效果评估作战效能指标
      </div>
      <div class="item div4 shou" @click="on4">4. 作战适用性指标体系</div>
    </div>
    <!-- </el-card> -->
  </div>
</template>
